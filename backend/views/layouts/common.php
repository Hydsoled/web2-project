        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Notes'),
                        'icon' => '<i class="glyphicon glyphicon-book"></i>',
                        'url' => ['/note/index'],
                        'active' => Yii::$app->controller->action->id === 'index' && Yii::$app->controller->id === "note",
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
                        ...
                        'icon' => '<i class="glyphicon glyphicon-book"></i>',
                        'url' => ['/blog/index'],
                        'active' => Yii::$app->controller->action->id === 'index' && Yii::$app->controller->id === "blog",
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
